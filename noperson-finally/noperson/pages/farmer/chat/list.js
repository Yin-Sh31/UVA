...
Page({
  ...
  goToChat: function(e) {
    ...
    wx.navigateTo({
      url: `/pages/farmer/chat/detail?conversationId=${conversationId}&otherUserId=${otherUserId}&otherUserName=${encodeURIComponent(otherUserName)}&otherUserType=${otherUserType}&otherUserAvatar=${encodeURIComponent(otherUserAvatar || '')}`
    });
  },
